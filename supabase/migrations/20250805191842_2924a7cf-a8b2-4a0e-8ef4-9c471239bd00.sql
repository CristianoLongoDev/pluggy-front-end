-- Remove the old jwt_custom_claims function that accepts json parameter
DROP FUNCTION IF EXISTS public.jwt_custom_claims(json);

-- Ensure the correct function exists with proper permissions
...
GRANT EXECUTE ON FUNCTION public.jwt_custom_claims(UUID) TO supabase_auth_admin;